...
HD_PWD='C:/Users/OAkun/Desktop/CECS460Micro/DetMicroBlazeLecTimerVideo/DetMicroBlazeLec.runs/DeterminantMicroBlaze_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DeterminantMicroBlaze_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DeterminantMicroBlaze_xbar_0.tcl
