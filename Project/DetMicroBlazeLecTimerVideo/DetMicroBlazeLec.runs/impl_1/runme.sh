...
HD_PWD='C:/Users/OAkun/Desktop/CECS460Micro/DetMicroBlazeLecTimerVideo/DetMicroBlazeLec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DeterminantMicroBlaze_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DeterminantMicroBlaze_wrapper.tcl -notrace
