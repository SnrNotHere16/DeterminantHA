...
HD_PWD='C:/Users/OAkun/Desktop/CECS460Micro/DetMicroBlazeLec/DetMicroBlazeLec.runs/DeterminantMicroBlaze_lmb_bram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DeterminantMicroBlaze_lmb_bram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DeterminantMicroBlaze_lmb_bram_0.tcl
