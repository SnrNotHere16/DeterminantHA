...
HD_PWD='C:/Users/OAkun/Desktop/CECS460Micro/DetMicroBlazeLecTimerVideo/DetMicroBlazeLec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DeterminantMicroBlaze_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DeterminantMicroBlaze_wrapper.tcl
